...
const About = () => {
  ...
  return (
    <>
      <section id="about" className="relative py-20 px-6 max-w-7xl grid grid-cols-[40%_60%] items-center gap-4">
          {/* Left: Image Side */}
          <div className="relative rounded-3xl overflow-hidden bg-slate-950 border border-slate-800 col-span-1">
            <img
